...
while (storeFewCustomers.IsOpen())
{
    ...
    {
        customer.FillCart(7);
        var cashRegisterFewCustomers = CustomerExtensions.FewCustomers(cashRegistersFewCustomers);
        ...
        else
        {
            ...
            break; // If there's no available cash register, break out of the loop
        }
    }
