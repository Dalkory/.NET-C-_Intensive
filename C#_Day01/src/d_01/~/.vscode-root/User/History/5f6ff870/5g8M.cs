...
Console.WriteLine("Less Customers: {0}", CustomerExtensions.FewCustomers(cashRegisters).Name);
Console.WriteLine("Less Goods: {0}", CustomerExtensions.ManyCustomers(cashRegisters).Name);
