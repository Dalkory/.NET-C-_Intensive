...
Console.WriteLine("{0}: {1} ({2}), {3} ({4})", cashRegister1.Name, customer1.Name, customer1.ItemsAmount, customer2.Name, customer2.ItemsAmount);
var cashRegister3 = new CashRegister("Register", 2);
cashRegister3.EnqueueCustomer(customer3);
Console.WriteLine("{0}: {1} ({2})", cashRegister3.Name, customer3.Name, customer3.ItemsAmount);
List<CashRegister> cashRegisters = new List<CashRegister>();
cashRegisters.Add(cashRegister1);
cashRegisters.Add(cashRegister3);
Console.WriteLine("Few Customers: {0}", CustomerExtensions.FewCustomers(cashRegisters).Name, CustomerExtensions.FewCustomers(cashRegisters).Id);
Console.WriteLine("Many Items: {0} #{1}", CustomerExtensions.ManyItems(cashRegisters).Name, CustomerExtensions.ManyItems(cashRegisters).Id);
