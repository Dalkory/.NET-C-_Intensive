...
cashRegister2.EnqueueCustomer(customer3);
Console.WriteLine("{0}: {1} ({2})", cashRegister2.Name, customer3.Name, customer3.ItemsAmount);
List<CashRegister> cashRegisters = new List<CashRegister>();
cashRegisters.Add(cashRegister1);
cashRegisters.Add(cashRegister2);
Console.WriteLine("Few Customers: {0}", CustomerExtensions.FewCustomers(cashRegisters).Name);
Console.WriteLine("Many Customers: {0}", CustomerExtensions.ManyCustomers(cashRegisters).Name);
